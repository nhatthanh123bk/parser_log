...
import com.fpt.parser.common.InfoAllColumn
class InfoAllColumnClick extends InfoAllColumn {
  ...
  override val listColumn = List(timestamp, version, bodyBytesSent, bytesSent, host, hostname, httpUserAgent,
